...
Gui Add, TreeView, x8 y8 w201 h328 -ReadOnly AltSubmit Checked

Gui Add, Button, x8 y344 w202 h23, Pazar KUR
Gui Add, Tab3, x208 y8 w241 h358, SELL|BUY
Gui Tab, 1
Gui Add, Text, hWndhTxtSlot x216 y32 w94 h23 +0x200 +Border, Slot

Gui Add, Text, x320 y32 w120 h23 +0x200 +Border, Fiyat
Gui Add, Text, x216 y56 w94 h23 +0x200, >>>> [1] >>>>>
Gui Add, Edit, vslot1fiyat x320 y56 w120 h21
Gui Add, Text, x216 y80 w94 h23 +0x200, >>>> [2] >>>>>
Gui Add, Edit, vslot2fiyat x320 y80 w120 h21
Gui Add, Text, x216 y104 w94 h23 +0x200, >>>> [3] >>>>>
Gui Add, Edit, vslot3fiyat x320 y104 w120 h21
Gui Add, Text, x216 y128 w94 h23 +0x200, >>>> [4] >>>>>
Gui Add, Edit, vslot4fiyat x320 y128 w120 h21
Gui Add, Text, x216 y152 w94 h23 +0x200, >>>> [5] >>>>>
Gui Add, Edit, vslot5fiyat x320 y152 w120 h21
Gui Add, Text, x216 y176 w94 h23 +0x200, >>>> [6] >>>>>
Gui Add, Edit, vslot6fiyat x320 y176 w120 h21
Gui Add, Text, x216 y200 w94 h23 +0x200, >>>> [7] >>>>>
Gui Add, Edit, vslot7fiyat x320 y200 w120 h21
Gui Add, Text, x216 y224 w94 h23 +0x200, >>>> [8] >>>>>
Gui Add, Edit, vslot8fiyat x320 y224 w120 h21
Gui Add, Text, x216 y248 w94 h23 +0x200, >>>> [9] >>>>>
Gui Add, Edit, vslot9fiyat x320 y248 w120 h21
Gui Add, Text, x216 y272 w94 h23 +0x200, >>>> [10] >>>>
Gui Add, Edit, vslot10fiyat x320 y272 w120 h21
Gui Add, Text, x216 y296 w94 h23 +0x200, >>>> [11] >>>>
Gui Add, Edit, vslot11fiyat x320 y296 w120 h21
Gui Add, Text, x216 y320 w94 h23 +0x200, >>>> [12] >>>>
Gui Add, Edit, vslot12fiyat x320 y320 w120 h21

global slot1fiyat, slot2fiyat, slot3fiyat, slot4fiyat, slot5fiyat, slot6fiyat, slot7fiyat, slot8fiyat, slot9fiyat, slot10fiyat, slot11fiyat, slot12fiyat

ID1 := TV_Add("Pazar-SELL", ID0)
global sell_slot1 := TV_Add("1.Slot", ID1)
global sell_slot2 := TV_Add("2.Slot", ID1)
global sell_slot3 := TV_Add("3.Slot", ID1)
global sell_slot4 := TV_Add("4.Slot", ID1)
global sell_slot5 := TV_Add("5.Slot", ID1)
global sell_slot6 := TV_Add("6.Slot", ID1)
global sell_slot7 := TV_Add("7.Slot", ID1)
global sell_slot8 := TV_Add("8.Slot", ID1)
global sell_slot9 := TV_Add("9.Slot", ID1)
global sell_slot10 := TV_Add("10.Slot", ID1)
global sell_slot11 := TV_Add("11.Slot", ID1)
global sell_slot12 := TV_Add("12.Slot", ID1)
ID2 := TV_Add("Pazar-BUY", ID0)

Gui Show, w457 h375, KO_Pazar [pirik3]


;{ Findtext
global Trade:="|<Trade>*102$32.0TzyTwzzzbzD271VnnwaHgxs9Y3DQmNDnrAaHgxsA62"
global Merchant:="|<Merchant>*93$50.CTzznzzyH7zzwzzzYFVkV1kkM0Hgn3DYmIY3Qwv1CZ9DrDCaHdSHhn3dYuLa3S4v1Cm"
global Selling:="|<Selling>*123$38.zzzzzzzzzOTzy3zqzzzjTxjzzny7PMQ6DiqqnRwEBhijTpzPPfpxiqquNUsBhikTzzzzzbzzzzz3zzzzzzs"
global Selling2:="|<Selling2>*91$39.002qU03y04U00E84aU04szYrxz7g4YUMCDCYYmNS84YbHBRDYYeN79oYZHA1UYYf1TryqpT800000300000Do"
global Buying:="|<Buying>*122$38.zzztzzkTzzzzxnzzzzzRrLhVkERqnPBpvRhquxSrRRijLhbDPdY71nqv1zzxzzyTzyTzwDzzzzzzU"
global itemquantity:="|<itemquantity>*87$37.zzzzznzzzzztsC6QUQ1qPCHaRyQb9nCzDHYtbTb9mQnbNYtCRsC70bC4"
global itemquantity_confirm:="|<itemquantity_confirm>*88$42.zzzyLzzkTzwrzzbzzwzzzDsMAK00Tn9YqNaTr9YqNaTrdYqNaDr9YqNabn9YqNakMNYqNaU"
global itemprice:="|<itemprice>*93$27.1kgA9qxjCCr/s1qxTDCr9tkCxVUDzzztzzzzU"
global itemprice_confirm:="|<itemprice_confirm>*88$42.zzzyLzzkTzwrzzbzzwzzzDsMAK00Tn9YqNaTr9YqNaTrdYqNaDr9YqNabn9YqNakMNYqNaU"
global pricedoublecheck:="|<pricedoublecheck>*87$32.xzzDDzTznnzrzwwzVX91A3GGGGNooYoUB9999sMsEn2"
global pricedoublecheck_confrim:="|<pricedoublecheck_confrim>*88$42.zzzyLzzkTzwrzzbzzwzzzDsMAK00Tn9YqNaTr9YqNaTrdYqNaDr9YqNabn9YqNakMNYqNaU"
;}



F1:: ; inventory uzerinde item koordinatlarini ve fiyatlarini belirleme
;MsgBox, 48, Uyari!,[1] Slot seciniz.`n[2] Daha sonra F1 tusuna basiniz., 2
Gui, Submit, NoHide
if (tv_get(sell_slot1, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	global xpos1, ypos1
	MouseGetPos, xpos1, ypos1
	ToolTip, Secilen koordinat-> X=%xpos1% / Y=%ypos1%
	InputBox, UserInput, Fiyat Giriniz, 1. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 1. slot icin fiyat belirlenmedi.
	else
		MsgBox, 1. Slot icin belirlediginiz fiyat = %UserInput%
	;guicontrol,,slot1fiyat, %UserInput%
	GuiControl,, slot1fiyat, % ThousandsSep(UserInput)
  }
  
  if (tv_get(sell_slot2, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos2, ypos2
	ToolTip, Secilen koordinat-> X=%xpos2% / Y=%ypos2%
	InputBox, UserInput, Fiyat Giriniz, 2. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 2. slot icin fiyat belirlenmedi.
	else
		MsgBox, 2. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot2fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot3, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos3, ypos3
	ToolTip, Secilen koordinat-> X=%xpos3% / Y=%ypos3%
	InputBox, UserInput, Fiyat Giriniz, 3. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 3. slot icin fiyat belirlenmedi.
	else
		MsgBox, 3. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot3fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot4, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos4, ypos4
	ToolTip, Secilen koordinat-> X=%xpos4% / Y=%ypos4%
	InputBox, UserInput, Fiyat Giriniz, 4. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 4. slot icin fiyat belirlenmedi.
	else
		MsgBox, 4. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot4fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot5, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos5, ypos5
	ToolTip, Secilen koordinat-> X=%xpos5% / Y=%ypos5%
	InputBox, UserInput, Fiyat Giriniz, 5. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 5. slot icin fiyat belirlenmedi.
	else
		MsgBox, 5. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot5fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot6, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos6, ypos6
	ToolTip, Secilen koordinat-> X=%xpos6% / Y=%ypos6%
	InputBox, UserInput, Fiyat Giriniz, 6. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 6. slot icin fiyat belirlenmedi.
	else
		MsgBox, 6. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot6fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot7, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos7, ypos7
	ToolTip, Secilen koordinat-> X=%xpos7% / Y=%ypos7%
	InputBox, UserInput, Fiyat Giriniz, 7. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 7. slot icin fiyat belirlenmedi.
	else
		MsgBox, 7. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot7fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot8, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos8, ypos8
	ToolTip, Secilen koordinat-> X=%xpos8% / Y=%ypos8%
	InputBox, UserInput, Fiyat Giriniz, 8. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 8. slot icin fiyat belirlenmedi.
	else
		MsgBox, 8. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot8fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot9, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos9, ypos9
	ToolTip, Secilen koordinat-> X=%xpos9% / Y=%ypos9%
	InputBox, UserInput, Fiyat Giriniz, 9. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 9. slot icin fiyat belirlenmedi.
	else
		MsgBox, 9. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot9fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot10, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos10, ypos10
	ToolTip, Secilen koordinat-> X=%xpos10% / Y=%ypos10%
	InputBox, UserInput, Fiyat Giriniz, 10. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 10. slot icin fiyat belirlenmedi.
	else
		MsgBox, 10. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot10fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot11, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos11, ypos11
	ToolTip, Secilen koordinat-> X=%xpos11% / Y=%ypos11%
	InputBox, UserInput, Fiyat Giriniz, 11. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 11. slot icin fiyat belirlenmedi.
	else
		MsgBox, 11. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot11fiyat, %UserInput%
  }
  
  if (tv_get(sell_slot12, "Check"))
  {
    KeyWait, LButton, D ; Wait for the left mouse button to be pressed down.
	MouseGetPos, xpos12, ypos12
	ToolTip, Secilen koordinat-> X=%xpos12% / Y=%ypos12%
	InputBox, UserInput, Fiyat Giriniz, 12. Slot Fiyati, , 150, 150
	if ErrorLevel
		MsgBox, 12. slot icin fiyat belirlenmedi.
	else
		MsgBox, 12. Slot icin belirlediginiz fiyat = %UserInput%
	guicontrol,,slot12fiyat, %UserInput%
  }  
  ToolTip, 
return

Home:: ; Pazar penceresini acma
Gui, Submit, NoHide
if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, Selling)) or (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, Selling2))
{
  MouseMove, X, Y
...
{
	if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, Merchant))
	{
	  MouseMove, X, Y
	  Send, {LButton down}{LButton up}
	}
	...
	{
		if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, Trade))
		{
		  MouseMove, X, Y
...
CapsLock:: ; pazar kurma(fiyat ve quantity) x'den 600 / y'den 30 eksilt.
Gui, Submit, NoHide
if (tv_get(sell_slot1, "Check"))
	{
		MouseMove, xpos1 - 600, ypos1 - 30
		Send, {LButton down}
		Sleep,100
		MouseMove, 670, 250, 100
		Sleep,100
		Send, {LButton up}
		Sleep,1000
		if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, itemquantity))
		{
			Sleep,1000
			if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, itemquantity_confirm))
			{
				MouseMove, X, Y
				Send, {LButton down}{LButton up}
				Sleep,1000
		...
		if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, itemprice))
		{
			Sleep,1000
			if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, itemprice_confirm))
			{
				SendRaw, %slot1fiyat%
				Sleep,1000
				MouseMove, X, Y
		...
		if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, pricedoublecheck))
		{
			Sleep,1000
			if (ok:=FindText(X, Y, 1467-150000, 133-150000, 1467+150000, 133+150000, 0, 0, pricedoublecheck_confrim))
			{
				MouseMove, X, Y
				Send, {LButton down}{LButton up}
			}
...
ThousandsSep(x, s := ",") {
 Return RegExReplace(StrReplace(x, ","), "\G\d+?(?=(\d{3})+(?:\D|$))", "$0" s)
}
