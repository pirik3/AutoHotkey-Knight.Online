...
;           [-] (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, spike)) bu kod icerisinde skillerin aranacak alanini kendiniz belirtiniz FindText uzerinden "GetRange" alarak. Orn.(8, 219, 180, 408 yerine 522, 279, 1004, 707 gibi)
;
...
spike:="|<spike>**50$4.v0Bzv803G808"
thrust:="|<thrust>**50$7.4zkMt0013C6ACTSS8"
vampirictouch:="|<vampirictouch>**50$7.2008ACaj6KDDSTRRc"
cut:="|<cut>**50$9.14Ea1UAHWoKeYYZgQCbbVkS6Vbts4"
illusion:="|<illusion>**50$7.wkFjrOB6XH/bbb7R8"
shock:="|<shock>**50$7.00000230008337DS8"
jab:="|<jab>**50$9.E010000000YFUMC73VES6Vbss03zY"
stab2:="|<stab2>**50$7.410cE421119AgywwM"
pierce:="|<pierce>**50$7.00000007zA0NxxwyqSOB"
stab:="|<stab>**50$7.1VlUMC733111VUU0M"
...
Loop
{
  if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, spike))
  {
    if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, thrust))
    {
      if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, vampirictouch))
      {
        if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, cut))
        {
          if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, illusion))
          {
            if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, shock))
            {
              if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, jab))
              {
                if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, stab2))
                {
                  if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, pierce))
                  {
                    if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, stab))
                    {
                      if (ok:=FindText(X:="wait0", Y:=0, 8, 219, 180, 408, 0, 0, blooddrain))
                      {
